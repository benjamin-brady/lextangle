...
<article class="prose prose-sm dark:prose-invert max-w-none space-y-4 text-sm leading-relaxed text-(--text)">
	...
	<h2 class="font-display text-lg font-bold pt-2">3. Acceptable Use</h2>
	<p>You agree not to:</p>
	<ul class="list-disc pl-5 space-y-1">
		<li>Use bots, scraping, or automation that harms service reliability</li>
		<li>Attempt to bypass rate limits, security controls, or access restrictions</li>
		<li>Submit unlawful, abusive, or deceptive content through feedback features</li>
	</ul>

	<h2 class="font-display text-lg font-bold pt-2">4. Availability and Changes</h2>
	<p>
		We may update, modify, or discontinue features at any time. We do not guarantee uninterrupted
		availability and may perform maintenance or emergency changes when needed.
	</p>

	<h2 class="font-display text-lg font-bold pt-2">5. Disclaimer</h2>
	<p>
	...
	<h2 class="font-display text-lg font-bold pt-2">7. Termination</h2>
	<p>
		We may suspend or terminate access if these Terms are violated or to protect the service,
		community, or legal compliance.
	</p>
